...
final class WTBasicMVVMTests: XCTestCase {
    ...
    private func makeSUT(items: [WalkthroughItem],
                         onFinishWalkthrough: @escaping WTBasicMVVMViewController.FinishCompletion = {}) -> WTBasicMVVMViewController {
        let vc = WTBasicMVVMComposer.compose(items: items,
                                             shouldAnimate: false,
