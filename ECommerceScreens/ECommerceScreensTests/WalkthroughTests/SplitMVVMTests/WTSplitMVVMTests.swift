...
final class WTSplitMVVMTests: XCTestCase {
    ...
    private func makeSUT(items: [WalkthroughItem],
                         onFinishWalkthrough: @escaping WTSplitMVVMViewController.FinishCompletion = {}) -> WTSplitMVVMViewController {
        let vc = WTSplitMVVMComposer.compose(items: items,
