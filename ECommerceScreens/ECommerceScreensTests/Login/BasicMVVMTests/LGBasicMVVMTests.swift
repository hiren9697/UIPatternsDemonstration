...
final class LGBasicMVVMTests: XCTestCase {
    ...
    private func makeSUT(toast: Toast = ToastSpy(),
                         ...
                         loginCompletion: @escaping LGBasicMVVMViewController.LoginCompletion = {},
                         file: StaticString = #filePath,
                         line: UInt = #line) -> LGBasicMVVMViewController {
        let sut = LGBasicMVVMComposer.compose(toast: toast,
    ...
    private func setValidEmailAndPassword(on sut: LGBasicMVVMViewController) -> (email: String, password: String) {
