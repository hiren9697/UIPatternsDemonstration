...
struct AppColors {
    ...
    static let c000000: UIColor = UIColor(named: "c000000", in: bundle, compatibleWith: nil)!
    static let cA8A8A9: UIColor = UIColor(named: "cA8A8A9", in: bundle, compatibleWith: nil)!
    static let cC4C4C4: UIColor = UIColor(named: "cC4C4C4", in: bundle, compatibleWith: nil)!
