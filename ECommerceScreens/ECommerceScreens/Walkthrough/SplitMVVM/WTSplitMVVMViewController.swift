...
public class WTSplitMVVMViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    let currentItemTrackingLabelController: WTSplitMVVMCurrentItemTrackingLabelController
    // Didn't mark `private` because test helper needs to acces it's views
    let bottomViewController: WTSplictMVVMBottomViewController
    private let cellControllers: [WTSplitMVVMCellController]
    private let shouldAnimate: Bool
    private let onFinish: FinishCompletion
    
    public init(cellControllers: [WTSplitMVVMCellController],
                currentItemTrackingLabelController: WTSplitMVVMCurrentItemTrackingLabelController,
                bottomViewController: WTSplictMVVMBottomViewController,
